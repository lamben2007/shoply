  ...
  return (
    <div className="flex flex-col min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      ...
      <p className="mb-4 text-lg text-center max-w-xl">
        Ce site e-commerce est <span className="font-semibold">factice</span>. Il a été réalisé dans le cadre d’un projet de démonstration pour enrichir mon portfolio.
      </p>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded p-4 shadow max-w-sm mb-4">
        ...
        <ul className="text-sm">
          <li>
            <span className="font-medium">Nom&nbsp;:</span> Laurent DUPONT
          </li>
          <li>
